...
<html lang="ko">
    ...
    <body>
        ...
        <div class="typer" id="h">
            <h1 style="text-align: center; font-family: Noto Sans KR,sans-serif; border-right: .1em solid #fff; font-size: 4vw; white-space: pre; line-height: 1; letter-spacing: .1rem; padding-top: .2em;">환영합니다.<br><br></h1>
